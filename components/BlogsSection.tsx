...
export default function BlogsSection() {
  ...
  return (
    <section id="components" className="mb-12 max-w-170 mx-auto px-6">
      ...
      <div className="flex items-center gap-2.5 text-[14px] text-stone-400 dark:text-stone-500 pt-4 border-t border-stone-100">
        <Pen />
        <span>
      ...
      <div className="mt-6 flex flex-col gap-3">
        {featured.map((entry) => (
          <Link
            ...
            className="group overflow-hidden rounded-lg border border-stone-100 bg-stone-50/50 transition-shadow hover:shadow-md dark:border-stone-700 dark:bg-stone-900/50 dark:hover:border-stone-600"
          >
            ...
            <div className="flex items-center justify-between gap-3 p-4">
              ...
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-stone-100 bg-white dark:border-stone-600 dark:bg-stone-800">
      ...
      <div className="mt-4 flex flex-col items-center gap-1.5">
        <Link
          href="/blogs"
          className="text-[13px] text-stone-500 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 transition-colors border border-stone-100 dark:border-stone-600 rounded-full px-4 py-1.5 bg-white dark:bg-stone-900"
        >
